...
from chat_gemini_2 import csv_prompter
...
with open("/Users/yuu/GitHub/ChatDoctor/Autonomous_ChatGPT_API/NER_chatgpt.json", "r") as f:
    ...
    selected_indices = selected_indices[270:400]
    ...
    for count, index in enumerate(tqdm(selected_indices,desc="Processing Questions",unit="question",dynamic_ncols=True)):
        try: 
            ...
            with open("/Users/yuu/GitHub/ChatDoctor/Autonomous_ChatGPT_API/NER_Gemini20_3.json","w",encoding="utf-8") as f2:
    ...
    with open("/Users/yuu/GitHub/ChatDoctor/Autonomous_ChatGPT_API/NER_Gemini20_3.json","w",encoding="utf-8") as f3:
